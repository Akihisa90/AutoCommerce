...
<head>
    ...
    <title><?php echo e(config('app.name', 'Otomotif Shop')); ?></title>
    ...
    <style>
        .auth-wrapper {
            min-height: 100vh;
            background: linear-gradient(135deg, #0F2E25 0%, #1B4D3E 50%, #111827 100%);
            display: flex;
            align-items: center;
...
<?php /**PATH D:\Ahmad\XAMPP\php\www\otomotif-shop-bak1\otomotif-shop\resources\views/layouts/guest.blade.php ENDPATH**/ ?>